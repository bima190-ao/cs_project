...
function tampilkan_error($pesan) {
    ...
    <head>
        ...
        <title>Pembayaran QRIS - Kebab & Burger</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pembayaran QRIS #<?php echo htmlspecialchars($order_id); ?> - Kebab & Burger</title>
    ...
    <style>
        ...
        /* Style untuk penyesuaian tema Kebab & Burger */
        .card-qris {
            max-width: 450px; 
            width: 100%; 
            border-radius: 20px; 
...
<div class="container my-5 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card card-qris shadow-lg p-4 text-center">
        ...
        <h5 class="fw-bold text-dark mb-1">Metode Pembayaran QRIS</h5>
        ...
        <div class="p-3 my-3 d-inline-block rounded-3 shadow-sm qr-box mx-auto">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=KEBABBURGER-ORDERID-<?php echo $order_id; ?>" 
                 alt="Barcode Pembayaran QRIS" class="img-fluid" style="width: 240px; height: 240px; border-radius: 8px;">
        </div>
        ...
        <div class="alert alert-warning py-3 mb-4 border-0 text-start shadow-sm" style="background-color: #fff3cd; border-radius: 12px;">
            <p class="text-dark small m-0" style="line-height: 1.5;">
                💡 <strong>Cara Membayar:</strong> Scan QR code di atas menggunakan aplikasi e-wallet favorit Anda (GoPay, OVO, Dana, LinkAja) atau melalui m-banking.
            </p>
        </div>
